...
/**
 * @author: FanJiaBao
 * @createDate: 2026/4/24 15:47
 * @description: 行为型模式.中介者模式:
...
public class MediatorPattern {
     ...
     *  一对多关联转变为一对一的关联
     *      没有使用中介者模式的时候, 同事对象之间的关系通常是一对多的, 引入中介者对象以后, 中介者对象和同事对象的关系通常变成双向的一对一,
     *      这会让对象的关系更容易理解和实现。
     * 缺:
    ...
    public static void main(String[] args) {
        ...
        // 房主对象
        HouseOwner houseOwner = new HouseOwner("开发商",mediator);
