...
/**
 * @author: FanJiaBao
 * @createDate: 2026/4/30 11:59
 * @description: 行为型模式.解释器模式:
 ...
 *  它以树状的形式表现编程语言的语法结构, 树上的每个节点都表示源代码中的一种结构。用树形来表示符合文法规则的句子。
 */
public class InterpreterPattern {
     ...
     *  客户端(Client):
     *      主要任务是将需要分析的句子或表达式转换成使用解释器对象描述的抽象语法树, 然后调用解释器的解释方法, 当然也可以通过环境角色
     *      间接访问解释器的解释方法。
     * <p>
     * 优点:
     *  易于改变和扩展文法
     ...
     *  增加新地解释表达式较为方便
     *      如果用户需要增加新地解释表达式只需要对应增加一个新的终结符表达式或非终结符表达式类, 原有表达式类代码无须修改, 符合 "开闭原则"
     * 缺点:
     *  对于复杂文法难以维护
