...
本项目用于学习 Java 设计模式，并结合 Spring、MyBatis、Tomcat、Dubbo、Drools、JPA/Hibernate、JDK 等真实框架源码，分析设计模式在实际框架中的应用场景和源码调用流程。

项目不仅包含基础 Demo，还重点通过源码调用链说明每种设计模式在真实框架中的角色分工、执行流程和设计价值。
